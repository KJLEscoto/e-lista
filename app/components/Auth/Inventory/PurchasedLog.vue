...
<template>
  <section class="space-y-3">
    <h2 class="font-semibold text-black/80">Purchased Log</h2>

    <!-- grouped by date -->
    <div v-for="group in logs" :key="group.date" class="space-y-3">

      <!-- date header / toggle -->
      <button @click="toggle(group.date)" class="w-full flex items-center justify-between py-1 cursor-pointer group">
